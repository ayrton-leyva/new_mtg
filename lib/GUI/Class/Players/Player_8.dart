...
class Player_8_Widget extends StatelessWidget {
  const Player_8_Widget({
    ...
    required this.sixth,
    required PageController controller_seventh,
    required this.seventh,
    required PageController controller_eighth,
    required this.eighth,
        ...
        _controller_seventh = controller_seventh,
        _controller_eighth = controller_eighth,
        super(key: key);
  ...
  final Player sixth;
  final PageController _controller_seventh;
  final Player seventh;
  final PageController _controller_eighth;
  final Player eighth;
